...
if {[string equal $devicePart "xczu9eg-ffvb1156-2-i" ]} {
  puts "xczu9eg-ffvb1156-2-i"
  set projName "axu9eg_trd"
} elseif {[string equal $devicePart "xczu15eg-ffvb1156-2-i" ]} {
  puts "xczu15eg-ffvb1156-2-i"
  set projName "axu15eg_trd"
} else {
  puts "Wrong Part!"
  return 0
}
...
set_property -dict [list CONFIG.PSU__I2C1__PERIPHERAL__ENABLE {1} CONFIG.PSU__I2C1__PERIPHERAL__IO {EMIO}] [get_bd_cells zynq_ultra_ps_e_0]
...
set_property -dict [list CONFIG.PSU__DDRC__CWL {16}] [get_bd_cells zynq_ultra_ps_e_0]
